<footer class="cs_footer cs_style_1 cs_type_1 cs_bg_filed cs_heading_bg" data-src="assets/img/footer_bg_2.jpg">
    <div class="container">
      <div class="cs_footer_top">
        <ul class="cs_footer_contact_info_list cs_mp_0">
          <li>
            <div class="cs_accent_color">
          ...
          <li>
            ...
            <div class="">
              <h3 class="cs_fs_24 cs_semibold cs_white_color cs_mb_2">Subscribe</h3>
              <p class="mb-0 cs_white_color">Sign Up for daily Update</p>
            </div>
          </li>
        </ul>
