<footer class="cs_footer cs_style_1 cs_type_1 cs_bg_filed cs_heading_bg" data-src="assets/img/footer_bg_2.jpg">
          ...
          <div class="cs_footer_col">
            <div class="cs_footer_widget">
              ...
              <ul class="cs_footer_menu">
                <li><a href="services">Tire Rotation & Balance</a></li>
                <li><a href="services">Complete Diagnostics</a></li>
                <li><a href="services">Exhaust System Repair</a></li>
                <li><a href="services">Express Oil Change</a></li>
                <li><a href="services">Cooling System Care</a></li>
              </ul>
            </div>
          </div>
          <div class="cs_footer_col">
